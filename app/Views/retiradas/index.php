    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formFiltrar" action="/retiradas" method="get">
                    <div class="row no-print">
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label for="">Cód.</label>
                                <input type="text" class="form-control" name="id_retirada" value="<?= (isset($id_retirada)) ? $id_retirada : "" ?>">
                            </div>
                        </div>
                        <?php if (isset($tipo)) : ?>
                            <div class="col-lg-3">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <div class="col-lg-8" style="text-align: right">
                    <a href="/retiradas" class="btn btn-danger"><i class="fas fa-filter"></i> Remover Filtro</a>
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body no-print">
                    <div class="row">
                        <div class="col-lg-12">
                            <a href="/retiradas/create" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Nova Retirada</a>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-12">
                            <h6 class="m-0 text-dark"><i class="fas fa-list"></i> <?= (isset($ultimos_cinco)) ? "Cinco últimas retiradas cadastradas" : "Registros" ?></h6>
                        </div><!-- /.col -->
                    </div>
                </div>
                <!-- /.card-header -->
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <h6><b>Critérios:</b> <?= (isset($id_retirada)) ? "Por cód." : "" ?><?= (isset($tipo)) ? " | Tipo=$tipo" : "" ?><?= (isset($data_inicio)) ? " | Data Inicio=$data_inicio e Data Final=$data_final" : "" ?></h6>
                        </div>
                    </div>
                </div>
                <!-- /.card-body -->
