                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="quantidade" name="quantidade" onkeyup="trocaVirguraPorPonto('quantidade')" value="<?= (isset($produto)) ? $produto['quantidade'] : "" ?>" required="">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="">VALOR UNITÁRIO</label>
                                    <input type="text" class="form-control" id="valor_unitario" name="valor_unitario" onkeyup="trocaVirguraPorPonto('valor_unitario')" value="<?= (isset($produto)) ? $produto['valor_unitario'] : "" ?>" required="">
                                </div>
                            </div>
