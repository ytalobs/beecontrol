                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <a href="/inventarioDoEstoque/listaProdutos/<?= $id_inventario ?>" class="btn btn-primary"><i class="fas fa-edit"></i> Alterar/Excluir Produto</a>
                            <a href="/inventarioDoEstoque/add/<?= $id_inventario ?>" class="btn btn-primary"><i class="fas fa-plus-circle"></i> Adicionar produto</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-lg-12">
                            <table id="" class="table table-bordered table-striped">
                                <thead>
                                    ...
                                    <tr>
                                        <td colspan="1"><b>EMPRESA:</b> <?= $empresa['nome_fantasia'] ?></td>
                                        <td colspan="4"><b>CNPJ:</b> <?= $empresa['cnpj'] ?></td>
                                    </tr>
                                    <tr>
                                        <td><b>INSC. EST.:</b> <?= $empresa['inscricao_estadual'] ?></td>
    ...
    $(function() {
        ...
        ?>
            <?php if ($alert == "success_add") : ?>
                Toast.fire({
                    type: 'success',
                    title: 'Produto adiciona com sucesso ao Inventário!'
                })
            <?php endif; ?>
        <?php endif; ?>
    });
