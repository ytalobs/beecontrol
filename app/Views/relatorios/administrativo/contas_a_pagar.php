                            ...
                            <div class="row" style="margin-top: 50px">
                                <div class="col-lg-12">
                                    <table id="" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th colspan="6" style="text-align: center">CONTAS À PAGAR</th>
                                            </tr>
                                            <tr>
                                                <th>Cód.</th>
                                                <th>Status</th>
										...
										<?php $total_contas_a_pagar = 0 ?>
                                            <?php if(!empty($contas)): ?>
                                                <?php foreach($contas as $conta): ?>
													...
													<?php $total_contas_a_pagar += ($conta['valor']) ?>
                                                <?php endforeach; ?>
												<tr>
													<td colspan="5"><b>TOTAL DE CONTAS A PAGAR:</b></td>
													<td><b><?= number_format($total_contas_a_pagar, 2, ',', '.') ?></b></td>
												</tr>
                                            <?php else: ?>
                                                <tr>
