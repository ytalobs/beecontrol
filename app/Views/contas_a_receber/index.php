    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formFiltrar" action="/contasReceber" method="get">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <div class="col-lg-8" style="text-align: right">
                    <a href="/contasReceber" class="btn btn-danger"><i class="fas fa-filter"></i> Remover Filtro</a>
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body no-print">
                    <div class="row">
                        <div class="col-lg-12">
                            <a href="/contasReceber/create" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Nova Conta à Receber</a>
    ...
    $(function() {
        ...
        ?>
            ...
            <?php elseif ($alert == "success_edit") : ?>
                Toast.fire({
                    type: 'success',
                    title: 'Conta à Receber atualizada com sucesso!'
                })
