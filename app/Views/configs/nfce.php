...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            <form action="/configs/store_nfce" method="post" enctype="multipart/form-data">
                <div class="card">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-sm-12">
                                <h6 class="m-0 text-dark"><i class="fas fa-edit"></i> CSC e CSCid</h6>
                            </div><!-- /.col -->
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-5">
                                <div class="form-group">
                                    <label for="">CSC</label>
                                    <input type="text" class="form-control" name="CSC" value="<?= $dados['CSC'] ?>" required="">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="">CSCid</label>
                                    <input type="text" class="form-control" name="CSCid" value="<?= $dados['CSCid'] ?>" required="">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    $(function() {
        ...
        ?>
            <?php if ($alert == "success_edit") : ?>
                Toast.fire({
                    type: 'success',
                    title: 'Dados da NFCe atualizados com sucesso!'
                })
            <?php endif; ?>
        <?php endif; ?>
    });
