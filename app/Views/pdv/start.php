                                        ...
                                        <?php if (!empty($produtos_do_pdv)) : ?>
                                            <?php foreach ($produtos_do_pdv as $produto) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                      <!--  <a href="#" data-toggle="modal" data-target="#alterar-valor-unitario-do-produto" onclick="preparaParaAlterarValoUnitarioDoProduto(<?= $produto['id_produto_pdv'] ?>, <?= $produto['valor_unitario'] ?>)"></a>-->
                                                    ...
                                                    <td>
														R$ <?= number_format($produto['valor_final'], 2, ',', '.') ?></td>
                                                    <td>
