        ...
        <div class="modal-content">
            ...
            <form action="/pdv/alteraQtdDoProduto/8" method="post">
                                    ...
                                    <?php if (!empty($caixas)) : ?>
                                        <?php foreach ($caixas as $caixa) : ?>
                                            <tr>
                                                ...
                                                <td><?= $caixa['status'] ?></td>
                                                <td><?= $caixa['data_de_abertura'] ?></td>
                                                <td><?= $caixa['hora_de_abertura'] ?></td>
                                                <td>
                                                    <a href="/pdv/start/<?= $caixa['id_caixa'] ?>" class="btn btn-primary" target="_blank">Selecionar</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php else: ?>
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <a href="/caixas/abrir" class="btn btn-info"><i class="fas fa-plus"></i> Abrir Novo Caixa</a>
                </div>
            </form>
        </div>
        <!-- /.modal-content -->
