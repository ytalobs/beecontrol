        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-12">
                            <a href="/servicosMaoDeObra/create" class="btn btn-primary"><i class="fa fa-user-plus"></i> Novo Serviço/Mão de Obra</a>
                        </div>
                    </div>
                </div>
                <!-- /.card-header -->
                                ...
                                <?php foreach ($servicos as $servico) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-danger style-action" onclick="confirmaAcaoExcluir('Deseja realmente excluir esse Serviço?', '/servicosMaoDeObra/delete/<?= $servico['id_servico'] ?>')"><i class="fa fa-trash"></i></button>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php endif; ?>
