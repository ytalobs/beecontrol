...
class OrdensDeServicosProvisorio extends Migration
{
	public function up()
	{
		$this->forge->addField([
		...
		$this->forge->createTable('ordens_de_servicos_provisorio');
	}
	...
	{
		$this->forge->dropTable('ordens_de_servicos_provisorio');
	}
}
